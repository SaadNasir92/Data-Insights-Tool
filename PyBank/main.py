...
file_path = os.path.join(script_dir, 'Resources', 'budget_data.csv')
...
def financial_analysis(path_to_csv):
    """
...
final_line_list = financial_analysis(file_path)
output_filename_path = os.path.join(script_dir, 'analysis', 'financial_analysis.txt')
